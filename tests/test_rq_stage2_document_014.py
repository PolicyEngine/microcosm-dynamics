"""Validation and mutation coverage for the sealed q74 stage-2 shard."""
...
import build_rq_stage2_document_014 as builder  # noqa: E402
...
def _capture_root() -> Path:
    ...
    if not (capture_root / "q74.pdf").exists():
        pytest.skip("staged PSID q74.pdf is unavailable")
    return capture_root
...
def test_document_014_reproduces_committed_sealed_annotation():
...
def test_document_014_mutations_fail_closed():
    capture_root = _capture_root()
