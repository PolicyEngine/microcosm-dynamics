"""Independent validation of the sealed R_Q document-17 annotation.

Every row assertion below is re-derived from ``fam1976_QxQs.pdf`` through the
...
SOURCE_PDF = CAPTURE_ROOT / "fam1976_QxQs.pdf"
ANNOTATION_PATH = (
    ROOT
    / "docs"
    / "analysis"
    / "rq_stage2_annotations"
    / "document_017_fam1976_QxQs_annotation_v1.json"
)
...
INTERVIEW_WAVE = 1976
PAGE_COUNT = 101
FILE_SIZE = 26_183_706
FILE_SHA256 = (
    "b337b7580d52898cb67c7150a141944c21563f3fc7e10983f16ca6941e617058"
)
...
def test_whole_document_locator_obeys_every_equation(sealed: dict) -> None:
    ...
    assert locator["filename"] == "fam1976_QxQs.pdf"
...
def test_empty_occurrence_pages_are_still_emitted(sealed: dict) -> None:
    ...
    assert len(empty) == PAGE_COUNT - 34
    assert {
