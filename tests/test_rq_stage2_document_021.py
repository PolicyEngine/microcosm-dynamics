...
Every row assertion below is re-derived from ``fam1978_QxQs.pdf`` through the
...
SOURCE_PDF = CAPTURE_ROOT / "fam1978_QxQs.pdf"
ANNOTATION_PATH = (
    ROOT
    / "docs"
    / "analysis"
    / "rq_stage2_annotations"
    / "document_021_fam1978_QxQs_annotation_v1.json"
)
...
INTERVIEW_WAVE = 1978
PAGE_COUNT = 95
FILE_SIZE = 24_868_051
FILE_SHA256 = (
    "8f4b53bf3ff8c5167b0770326c59c54aee6a14382dc9e191071e4e22298fb868"
)
...
def test_whole_document_locator_obeys_every_equation(sealed: dict) -> None:
    ...
    assert locator["filename"] == "fam1978_QxQs.pdf"
...
def test_empty_occurrence_pages_are_still_emitted(sealed: dict) -> None:
    ...
    # Every retained page is a printed instrument screen: from page 4
    # onwards the even pages carry the instrument and the odd pages carry
    # its facing objectives sheet.  No objectives sheet is retained.
    assert all(page >= 4 and page % 2 == 0 for page in RETAINED_PAGES)
