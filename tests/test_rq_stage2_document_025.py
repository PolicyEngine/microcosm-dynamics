"""Independent validation of the sealed R_Q document-25 annotation.

Every row assertion below is re-derived from ``fam1980_QxQs.pdf`` through the
...
SOURCE_PDF = CAPTURE_ROOT / "fam1980_QxQs.pdf"
ANNOTATION_PATH = (
    ROOT
    / "docs"
    / "analysis"
    / "rq_stage2_annotations"
    / "document_025_fam1980_QxQs_annotation_v1.json"
)
...
INTERVIEW_WAVE = 1980
PAGE_COUNT = 114
FILE_SIZE = 33_215_797
FILE_SHA256 = (
    "17586195e3bb9e817bdc48dc3e3dfd8f916c28483030fb574b905ea86874792e"
)
...
def test_whole_document_locator_obeys_every_equation(sealed: dict) -> None:
    ...
    assert locator["filename"] == "fam1980_QxQs.pdf"
