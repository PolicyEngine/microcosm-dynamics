"""Independent validation of the sealed R_Q document-18 annotation.

Every row assertion below is re-derived from ``q76.pdf`` through the
...
SOURCE_PDF = CAPTURE_ROOT / "q76.pdf"
ANNOTATION_PATH = (
    ROOT
    / "docs"
    / "analysis"
    / "rq_stage2_annotations"
    / "document_018_q76_annotation_v1.json"
)
...
FILE_SIZE = 2_384_753
FILE_SHA256 = (
    "d6e02857ca6ae7b0483bc0426ebe68374813219fba8efd9692f7d765389be624"
)
...
def test_whole_document_locator_obeys_every_equation(sealed: dict) -> None:
    ...
    assert locator["filename"] == "q76.pdf"
...
def test_empty_occurrence_pages_are_still_emitted(sealed: dict) -> None:
    ...
    assert len(empty) == PAGE_COUNT - 33
    assert {
