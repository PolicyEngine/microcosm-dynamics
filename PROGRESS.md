# Amendment 8 authoring progress
...
- Read the blocked v3-compiler report.
- Verified the clean branch starts at `origin/master` (`5347bdc`).
- Verified the revision-9 design document byte length and SHA-256.
- Audited all explicit range-bearing relation families and §20/§21
