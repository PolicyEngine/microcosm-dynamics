...
def main() -> int:
    ...
    payload = {
        ...
        "concept_deltas": [
            ...
            "immigrants",
            "Census July 1, 2008 single ages are used as end-of-2008 ages "
            "(birth_year = 2008 - July 1 age), so the synthetic "
            "non-entitled population is about half a year younger than the "
            "December 2008 population; the Table 20 stock keeps its own "
            "December age groups",
