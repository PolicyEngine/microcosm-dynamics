...
REVIEWED_IMPLEMENTATION_COMMIT = "1c7f3540802870c2fed94ff7cc04ad9b80163996"
...
POST_REVIEW_SOURCE_EXCLUSIONS = (
    ...
    Path("src/populace_dynamics/data/historical_coverage_rule_validation.py"),
...
def _assert_input_identity() -> None:
    ...
    paths = (
        ...
        *(f":(exclude){path}" for path in POST_REVIEW_SOURCE_EXCLUSIONS),
    )
    committed = _run_git(
        "diff",
        "--quiet",
