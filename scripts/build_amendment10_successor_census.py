...
EXPECTED_A10_R04_PINS = GatePins(
    ...
    count_rows=(
        ("compiled_source_numeric_grammar", 4842),
        (
            "compiled_source_numeric_grammar_padding_underdetermined_exact_replay",
            171,
        ),
        ...
        ("conflicting_source_numeric_format", 1),
        ("unsupported_source_numeric_format", 421),
        ("incomplete_source_numeric_authority", 15654),
    ),
    count_array_sha256="c3e5526c53989f2b1bba760c677e2302eaff1f43b9edbfda8d3fc609070151e4",
    ordered_assignment_sha256="00266992e0781abb8b90e23c023a8a8088dfff04338c0ec3118f72c206357a6a",
    status_matrix_rows=(
        (
            "compiled_source_numeric_grammar",
            (39, 96, 1707, 1216, 1066, 718),
            4842,
            "20b9d3538049f5aa9cc46be343c4309f80d92fb43d16e04c99e3b244b523562c",
        ),
        (
            "compiled_source_numeric_grammar_padding_underdetermined_exact_replay",
            (2, 14, 123, 10, 14, 8),
        ...
        (
            ...
            (1064, 555, 3573, 2661, 4964, 2837),
            15654,
            "71a4ae7c17f2fbdb5e40d26b257995e999a0a17726d5087df07667d22c68ad63",
        ),
    ),
    movement_row_count=14841,
    movement_rows_sha256="56faeb67e26911a284def43bd4025554c632f5a039c940eb033acd259605aefe",
    movement_key_sha256="baf84589ff5c81ab13d78ed1c07014d461ea0bfd883e57382d451b503c023b25",
    failure_reason_rows=(
        (
            "conflicting_source_numeric_format",
    ...
    failure_reason_rows_byte_count=265996,
    failure_reason_rows_sha256="84db7e467a2d4004769ada49b75f91a296b9b0ad99ea250c1b9096b961422291",
    ...
    denotation_candidate_table_sha256="010961ded9f62dfb45f414029fdd27c22f326509d7ee2cd78cf0a650660df7e9",
    denotation_start_occurrence_row_count=2240669,
    denotation_start_occurrence_byte_count=268223757,
    denotation_start_occurrence_sha256="9dbbf103fb2de53210383da3bfa8c16aac4c1367addfc43e890516775c28c850",
    denotation_start_partition_rows=(
        ("whole_domain_denotation", 8258),
        ("explicit_no_whole_domain_denotation", 4532),
        ("explicit_no_denotation", 2227879),
    ...
    segment_start_authority_relation_sha256="67a1aa301ee79a4939e27f9b95a0795c8aa935b54b9f38bea22af9b728dbeee9",
    segment_start_authority_array_sha256="ddd4a48d3508247e4be04bd2959ca1b59bbf5f4b448ca843fc2d044804f795e1",
    ...
    census_payload_sha256="62447bc5ea312a6ebe6b41d146603ab15a51d8d38b25dafd1fa42808ca7fb4ee",
)
